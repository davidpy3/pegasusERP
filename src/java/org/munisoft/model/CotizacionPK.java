...
public class CotizacionPK implements Serializable {
    ...
    public CotizacionPK(String anoEje, Character clasifica, int nRequer, int nCotiza) {
        this.anoEje = anoEje;
    ...
    public String toString() {
        return "org.munisoft.model.CotizacionPK[ anoEje=" + anoEje + ", clasifica=" + clasifica + ", nRequer=" + nRequer + ", nCotiza=" + nCotiza + " ]";
    }
