 ...
 */
@Embeddable
public class DepreciacionBienePK implements Serializable {
    ...
    public DepreciacionBienePK() {
    }

    public DepreciacionBienePK(long codPeriodo, String codBien, String correla, int item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DepreciacionBienePK)) {
            return false;
        }
        DepreciacionBienePK other = (DepreciacionBienePK) object;
