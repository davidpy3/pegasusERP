...
public class ProcesoPK implements Serializable {
    ...
    public ProcesoPK(String anoEje, Character clasifica, int nRequer, int item) {
        this.anoEje = anoEje;
    ...
    public String toString() {
        return "org.munisoft.model.ProcesoPK[ anoEje=" + anoEje + ", clasifica=" + clasifica + ", nRequer=" + nRequer + ", item=" + item + " ]";
    }
