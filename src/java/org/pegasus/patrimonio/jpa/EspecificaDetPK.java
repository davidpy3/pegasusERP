 ...
 */
@Embeddable
public class EspecificaDetPK implements Serializable {
    ...
    public EspecificaDetPK() {
    }

    public EspecificaDetPK(String anoEje, Character tipoTransaccion, String generica, String subgenerica, String subgenericaDet, String especifica, String especificaDet) {
        this.anoEje = anoEje;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EspecificaDetPK)) {
            return false;
        }
        EspecificaDetPK other = (EspecificaDetPK) object;
    ...
    public String toString() {
        return "org.munisoft.model.EspecificaDetPK[ anoEje=" + anoEje + ", tipoTransaccion=" + tipoTransaccion + ", generica=" + generica + ", subgenerica=" + subgenerica + ", subgenericaDet=" + subgenericaDet + ", especifica=" + especifica + ", especificaDet=" + especificaDet + " ]";
    }
