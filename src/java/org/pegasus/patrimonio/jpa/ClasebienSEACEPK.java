 ...
 */
@Embeddable
public class ClasebienSEACEPK implements Serializable {
    ...
    public ClasebienSEACEPK() {
    }

    public ClasebienSEACEPK(Character tipoBien, String grupoBien, String claseBien) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ClasebienSEACEPK)) {
            return false;
        }
        ClasebienSEACEPK other = (ClasebienSEACEPK) object;
    ...
    public String toString() {
        return "org.munisoft.model.ClasebienSEACEPK[ tipoBien=" + tipoBien + ", grupoBien=" + grupoBien + ", claseBien=" + claseBien + " ]";
    }
