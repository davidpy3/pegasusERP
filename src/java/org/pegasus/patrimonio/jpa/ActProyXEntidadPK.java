 ...
 */
@Embeddable
public class ActProyXEntidadPK implements Serializable {
    ...
    public ActProyXEntidadPK() {
    }

    public ActProyXEntidadPK(String anoEje, String actProy) {
        this.anoEje = anoEje;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ActProyXEntidadPK)) {
            return false;
        }
        ActProyXEntidadPK other = (ActProyXEntidadPK) object;
    ...
    public String toString() {
        return "org.munisoft.model.ActProyXEntidadPK[ anoEje=" + anoEje + ", actProy=" + actProy + " ]";
    }
