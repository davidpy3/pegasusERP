...
import org.pegasus.patrimonio.ejb.UbigeoFacade;
...
import org.pegasus.patrimonio.ejb.UbigeoFacadeLocal;
...
public class UbigeoController implements Serializable {
    ...
    @EJB
    private org.pegasus.patrimonio.ejb.UbigeoFacadeLocal ejbFacade;
    ...
    private UbigeoFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class UbigeoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Ubigeo) {
                ...
                return getStringKey(o.getCodubigeo());
            } else {
