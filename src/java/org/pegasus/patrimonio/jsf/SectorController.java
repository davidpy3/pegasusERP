...
import org.pegasus.patrimonio.ejb.SectorFacadeLocal;
...
public class SectorController implements Serializable {
    ...
    @EJB
    private org.pegasus.patrimonio.ejb.SectorFacadeLocal ejbFacade;
    ...
    private SectorFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SectoresCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SectoresUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SectoresDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Sector getSectores(java.lang.String id) {
    ...
    public static class SectoresControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SectorController controller = (SectorController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "sectoresController");
            return controller.getSectores(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sector) {
                ...
                return getStringKey(o.getCodSect());
            } else {
