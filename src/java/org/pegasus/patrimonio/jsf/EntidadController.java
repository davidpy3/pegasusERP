...
import org.pegasus.patrimonio.ejb.EntidadFacade;
...
import org.pegasus.patrimonio.ejb.EntidadFacadeLocal;
...
public class EntidadController implements Serializable {
    ...
    @EJB
    private org.pegasus.patrimonio.ejb.EntidadFacadeLocal ejbFacade;
    ...
    private EntidadFacadeLocal getFacade() {
        return ejbFacade;
    }
