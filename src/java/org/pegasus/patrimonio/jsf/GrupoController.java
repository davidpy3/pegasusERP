...
import org.pegasus.personal.ejb.GrupoFacadeLocal;
...
public class GrupoController implements Serializable {
    ...
    @EJB
    private org.pegasus.personal.ejb.GrupoFacadeLocal ejbFacade;
    ...
    private GrupoFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class GrupoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Grupo) {
                ...
                return getStringKey(o.getGrupo());
            } else {
