 ...
 */
@Stateless
public class CuentacFacade extends AbstractFacade<Cuentac> implements CuentacFacadeLocal{
    ...
    public CuentacFacade() {
        super(Cuentac.class);
    }

    @Override
    public List<Cuentac> findRange(int first, int max) {
