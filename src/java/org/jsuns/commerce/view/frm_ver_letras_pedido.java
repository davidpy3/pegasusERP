...
public class frm_ver_letras_pedido extends XPanel{
/*
    LetraPedido letras = new LetraPedido();
    ...
    javax.swing.JTextField lbl_dni;
    ...
    private javax.swing.JTextField lbl_tipo_doc;
    ...
    public void setPedido(Object p) {
        pedido=(Pedido)p;
        lbl_dni.setText(pedido.getCliente().getNroDoc());
        lbl_nombre.setText(pedido.getCliente().getNombreCompleto());
        lbl_tipo_doc.setText(pedido.getTipoDoc().toString());
        lbl_fecha.setText(pedido.getFecha().toString());
        lbl_total.setText(pedido.getTotal().toString());
            ...
            String sql = "select idLetras_Pedido, tipo_pago, monto,"
                    + "fecha, idPedido "
                    + "from letras_pedido "
                    + "where idPedido='" + id + "' ";
...
//            }
        ...
        t_letras.getColumnModel().getColumn(1).setPreferredWidth(100);
        t_letras.getColumnModel().getColumn(2).setPreferredWidth(80);
        lbl_pagado.setText(pagados() + "");
        resta();
    }
        
    public double pagados(){
        double pag = 0;
            String sql = "select sum(monto) as calculo from "
                    + "letras_pedido where idPedido='" + id + "'";
        return pag;
    }*/
}
