...
import org.jsuns.commerce.ejb.ClasificacionFacadeLocal;
...
public class ClasificacionController implements Serializable {
    ...
    @EJB
    private org.jsuns.commerce.ejb.ClasificacionFacadeLocal ejbFacade;
    ...
    private ClasificacionFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class ClasificacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Clasificacion) {
                ...
                return getStringKey(o.getIdClas());
            } else {
