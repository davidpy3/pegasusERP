...
import org.jsuns.commerce.ejb.KardexFacade;
...
import org.jsuns.commerce.ejb.KardexFacadeLocal;
...
public class KardexController implements Serializable {
    ...
    @EJB
    private org.jsuns.commerce.ejb.KardexFacadeLocal ejbFacade;
    ...
    private KardexFacadeLocal getFacade() {
        return ejbFacade;
    }
