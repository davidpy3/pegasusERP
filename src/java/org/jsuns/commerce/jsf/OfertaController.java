...
import org.jsuns.commerce.ejb.OfertaFacade;
...
import org.jsuns.commerce.ejb.OfertaFacadeLocal;
...
public class OfertaController implements Serializable {
    ...
    @EJB
    private org.jsuns.commerce.ejb.OfertaFacadeLocal ejbFacade;
    ...
    private OfertaFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("OfertaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("OfertaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("OfertaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Oferta getOferta(java.lang.Integer id) {
