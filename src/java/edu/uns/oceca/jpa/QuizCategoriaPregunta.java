...
public class QuizCategoriaPregunta implements Serializable {
    ...
    public QuizCategoriaPregunta() {
    }

    public QuizCategoriaPregunta(Integer idCategoria) {
        this.idCategoria = idCategoria;
    }

    public QuizCategoriaPregunta(Integer idCategoria, String nombre) {
        this.idCategoria = idCategoria;
        this.nombre = nombre;
    }
    ...
    public boolean equals(Object object) {
        ...
        QuizCategoriaPregunta other = (QuizCategoriaPregunta) object;
