...
import edu.uns.oceca.ejb.SgcFuentePreguntaFacadeLocal;
...
@Named("sgcFuentePreguntaController")
@SessionScoped
public class SgcFuentePreguntaController implements Serializable {
    ...
    private SgcFuentePreguntaFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SgcFuentePreguntaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SgcFuentePreguntaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SgcFuentePreguntaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class SgcFuentePreguntaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SgcFuentePreguntaController controller = (SgcFuentePreguntaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "sgcFuentePreguntaController");
            return controller.getSgcFuentePregunta(getKey(value));
        }
