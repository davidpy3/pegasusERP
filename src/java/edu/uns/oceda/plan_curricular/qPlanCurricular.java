...
public class qPlanCurricular extends Q{

    public qPlanCurricular(){
        setQuery("SELECT cur_plan_curricular.id_plancur,"
                + "cur_plan_curricular.codplancur,"
                + "cur_plan_curricular.id_especialidad,"
                + "aps_especialidad.especialidad,"
                + "cur_plan_curricular.id_anio,"
                + "cur_plan_curricular.denominacion,"
                + "cur_plan_curricular.id_plancondi ,"
                + "cur_plan_condicion.nombre condicion,"
                + "cur_plan_curricular.id_planmoda ,"
                + "cur_plan_modalidad.nombre modalidad,"
                + "cur_plan_curricular.id_planejec,cur_plan_ejecucion.nombre ejecucion,"
